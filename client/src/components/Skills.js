    ...
    return (
        <section className="rounded p-4 mb-4">
            <article className="container py-5" id="skills">
                ...
                <section className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 g-4">
                    {/* Golang */}
                    <article className="col">
                        <section className="card h-100 d-flex">
                    ...
                    <article className="col">
                        <section className="card h-100">
                            ...
                            </div>                            <article className="card-body">
                    ...
                    <article className="col">
                        <section className="card h-100 ">
                            <div className="text-center">
                                <Image src={R} alt="R" width={100} height={100} className="card-img-top mt-3" style={{ width: "fit-content" }} />
                            </div>                            <article className="card-body">
                    ...
                    <article className="col">
                        <section className="card h-100  d-flex">
                            <div className="text-center">
                                <Image src={SQL} alt="SQL" width={100} height={100} className="card-img-top mt-3" style={{ width: "fit-content" }} />
                            </div>                            <article className="card-body">
